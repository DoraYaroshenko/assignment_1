...
class AVLTreeTester2022(unittest.TestCase):
    ...
    # def test_delete_first_check_small_size(self):
    #     real_length = 0
    #     for i in range(10):
    #         self.tree.insert(i, str(i))
    #         real_length += 1
    #         self.assertEqual(real_length, self.tree.size(), "FAIL: Tree size incorrect")
    #     for i in range(9):
    #         deleted_value = self.tree.search(i)[0].key
    #         self.tree.delete(self.tree.search(i)[0])
    #         real_length -= 1
    #         print_tree(self.tree.root)
    #         print("deleted value ", deleted_value)
    #         print("needed len ",real_length)
    #         print("the len we get",self.tree.size())
    #         self.assertEqual(real_length, self.tree.size(), "FAIL: Tree size incorrect")
